...
const translations = {
  ...
  "engine.terminate": { en: "Stop gracefully", de: "Graceful stoppen", fr: "Arrêter proprement" },
  "engine.terminating": { en: "Stopping…", de: "Wird gestoppt…", fr: "Arrêt…" },
  "engine.forceTerminate": { en: "Force kill", de: "Sofort beenden", fr: "Forcer l’arrêt" },
  "engine.forceTerminating": { en: "Force killing…", de: "Wird sofort beendet…", fr: "Arrêt forcé…" },
  ...
  "annotations.title": { en: "Annotations", de: "Kommentare", fr: "Annotations" },
  "annotations.selectMove": { en: "Select a move to view or edit its annotations.", de: "Wähle einen Zug, um seine Kommentare und Varianten zu bearbeiten.", fr: "Sélectionnez un coup pour afficher ou modifier ses annotations." },
  "annotations.unsaved": { en: "Unsaved changes", de: "Ungespeicherte Änderungen", fr: "Modifications non enregistrées" },
  "annotations.catAssessment": { en: "CAT assessment", de: "CAT-Bewertung", fr: "Évaluation CAT" },
  "annotations.none": { en: "none", de: "keine", fr: "aucune" },
  "annotations.addToGame": { en: "Add to game", de: "In Partie übernehmen", fr: "Ajouter à la partie" },
  "annotations.moveAnnotation": { en: "Move annotation", de: "Zugbewertung", fr: "Annotation du coup" },
  "annotations.comment": { en: "Comment", de: "Kommentar", fr: "Commentaire" },
  "annotations.commentPlaceholder": { en: "Add your own comment…", de: "Eigenen Kommentar hinzufügen…", fr: "Ajouter votre commentaire…" },
  "annotations.evaluation": { en: "Stored evaluation", de: "Gespeicherte Bewertung", fr: "Évaluation enregistrée" },
  "annotations.useCurrentEvaluation": { en: "Use current evaluation", de: "Aktuelle Bewertung übernehmen", fr: "Utiliser l’évaluation actuelle" },
  "annotations.savedVariations": { en: "Saved variations", de: "Gespeicherte Varianten", fr: "Variantes enregistrées" },
  "annotations.noVariations": { en: "No saved variations.", de: "Keine gespeicherten Varianten.", fr: "Aucune variante enregistrée." },
  "annotations.engineAlternatives": { en: "Engine alternatives", de: "Engine-Alternativen", fr: "Variantes du moteur" },
  "annotations.noEngineAlternatives": { en: "No engine alternatives are available for this move.", de: "Für diesen Zug sind keine Engine-Alternativen verfügbar.", fr: "Aucune variante du moteur n’est disponible pour ce coup." },
  "annotations.added": { en: "Added", de: "Übernommen", fr: "Ajoutée" },
  "annotations.addVariation": { en: "Add variation", de: "Variante übernehmen", fr: "Ajouter la variante" },
  "annotations.saving": { en: "Saving…", de: "Wird gespeichert…", fr: "Enregistrement…" },
  "annotations.saveChanges": { en: "Save changes", de: "Änderungen speichern", fr: "Enregistrer les modifications" },
  "annotations.savedAnnotation": { en: "Saved game annotation", de: "Gespeicherte Partieannotation", fr: "Annotation enregistrée" },
  "annotations.saveFailed": { en: "Could not save the game annotations.", de: "Partiekommentare konnten nicht gespeichert werden.", fr: "Impossible d’enregistrer les annotations de la partie." },
  ...
  "settings.subtitle": {
    en: "Engines, reusable profiles, assignments, and runtime diagnostics",
    de: "Engines, wiederverwendbare Profile, Zuordnungen und Laufzeitdiagnose",
    fr: "Moteurs, profils réutilisables, affectations et diagnostic d’exécution",
  },
  "settings.version": { en: "Version {version}", de: "Version {version}", fr: "Version {version}" },
  "settings.scanSystem": { en: "Scan server engines", de: "Server-Engines suchen", fr: "Rechercher les moteurs serveur" },
  "settings.reset": { en: "Reset Engines & Profiles", de: "Engines und Profile zurücksetzen", fr: "Réinitialiser moteurs et profils" },
  "settings.area": { en: "Settings area", de: "Bereich Einstellungen", fr: "Zone des paramètres" },
  "settings.enginesAndProfiles": { en: "Engines & Profiles", de: "Engines & Profile", fr: "Moteurs et profils" },
  "settings.enginesAndProfilesDescription": { en: "Engines are the top level; profiles belong to one engine.", de: "Engines bilden die oberste Ebene; Profile gehören jeweils zu genau einer Engine.", fr: "Les moteurs constituent le niveau supérieur ; chaque profil appartient à un moteur." },
  "settings.importEngine": { en: "Import engine", de: "Engine importieren", fr: "Importer un moteur" },
  "settings.importEngineDescription": { en: "Register an engine once. Its executable and detected UCI definition remain read-only afterwards.", de: "Eine Engine wird einmal registriert. Programmdatei und erkannte UCI-Definition bleiben danach schreibgeschützt.", fr: "Enregistrez un moteur une seule fois. Son exécutable et sa définition UCI détectée restent ensuite en lecture seule." },
  "settings.engineImportedCreateProfile": { en: "Engine imported. Create a profile for it next.", de: "Engine importiert. Erstelle als Nächstes ein Profil dafür.", fr: "Moteur importé. Créez maintenant un profil pour celui-ci." },
  "settings.profilesForEngine": { en: "Profiles for {engine}", de: "Profile für {engine}", fr: "Profils pour {engine}" },
  "settings.profilesForEngineDescription": { en: "Profiles contain the actual UCI configuration used by the application.", de: "Profile enthalten die eigentliche UCI-Konfiguration, die von der Anwendung verwendet wird.", fr: "Les profils contiennent la configuration UCI réellement utilisée par l’application." },
  "settings.profileBelongsToEngine": { en: "Profile for {engine}", de: "Profil für {engine}", fr: "Profil pour {engine}" },
  "settings.engineReadOnlyDescription": { en: "Imported engine definition · read-only. Configure runtime behavior through profiles.", de: "Importierte Engine-Definition · schreibgeschützt. Das Laufzeitverhalten wird ausschließlich über Profile konfiguriert.", fr: "Définition du moteur importé · lecture seule. Configurez le comportement via les profils." },
  "settings.profileCount": { en: "{count} profile(s)", de: "{count} Profil(e)", fr: "{count} profil(s)" },
  "settings.noProfilesForEngine": { en: "No profile exists for this engine yet.", de: "Für diese Engine existiert noch kein Profil.", fr: "Aucun profil n’existe encore pour ce moteur." },
  "settings.deleteProfilesBeforeEngine": { en: "Delete the engine's profiles first.", de: "Lösche zuerst die Profile dieser Engine.", fr: "Supprimez d’abord les profils de ce moteur." },
  "settings.selectOrImportEngine": { en: "Select an engine or import a new one.", de: "Wähle eine Engine aus oder importiere eine neue.", fr: "Sélectionnez un moteur ou importez-en un nouveau." },
  "settings.loadingConfiguration": { en: "Loading engine configuration…", de: "Engine-Konfiguration wird geladen…", fr: "Chargement de la configuration moteur…" },
  "settings.mobileMoreActions": { en: "More settings actions", de: "Weitere Einstellungsaktionen", fr: "Autres actions de paramètres" },
  "settings.manualEngineSetup": { en: "Manual engine setup", de: "Engine manuell einrichten", fr: "Configuration manuelle du moteur" },
  "settings.showAdvancedOptions": { en: "Show UCI options ({count})", de: "UCI-Optionen anzeigen ({count})", fr: "Afficher les options UCI ({count})" },
  "settings.hideAdvancedOptions": { en: "Hide UCI options", de: "UCI-Optionen ausblenden", fr: "Masquer les options UCI" },
  ...
  "settings.engineLog": { en: "Engine Log", de: "Engine-Log", fr: "Journal moteur" },
  ...
  "engine.terminateConfirm": { en: "Gracefully stop engine {pid} ({label})?", de: "Engine {pid} ({label}) graceful stoppen?", fr: "Arrêter proprement le moteur {pid} ({label}) ?" },
  "engine.forceTerminateConfirm": { en: "Force-kill engine process {pid} ({label})? Use this only if graceful stop fails.", de: "Engine-Prozess {pid} ({label}) sofort beenden? Nur verwenden, wenn Graceful Stop fehlschlägt.", fr: "Forcer l’arrêt du processus moteur {pid} ({label}) ? À utiliser uniquement si l’arrêt propre échoue." },
  ...
  "settings.selectExecutableStep": { en: "Step 1 · Select an engine discovered on the server or enter a server executable path", de: "Schritt 1 · Auf dem Server gefundene Engine auswählen oder Server-Pfad eingeben", fr: "Étape 1 · Sélectionnez un moteur détecté sur le serveur ou saisissez un chemin serveur" },
  ...
  "settings.enginePathFallback": { en: "Server executable path", de: "Server-Pfad zur Programmdatei", fr: "Chemin serveur de l’exécutable" },
  "settings.engineFileDialogInfo": { en: "Engine executables belong to the backend host. The browser does not open a file manager on the server. Choose a discovered server engine or enter an explicit server path.", de: "Engine-Programmdateien gehören zum Backend-Host. Der Browser öffnet keinen Dateimanager auf dem Server. Wähle eine gefundene Server-Engine oder gib einen expliziten Server-Pfad ein.", fr: "Les exécutables des moteurs appartiennent à l’hôte backend. Le navigateur n’ouvre pas de gestionnaire de fichiers sur le serveur. Sélectionnez un moteur détecté ou saisissez un chemin serveur explicite." },
  ...
  "database.playerPairHint": { en: "If both names are set, both must occur in the game. The optional color assignment restricts who played White and Black.", de: "Sind beide Namen gesetzt, müssen beide in der Partie vorkommen. Über die optionale Farbzuordnung lässt sich festlegen, wer Weiß und Schwarz gespielt hat.", fr: "Si les deux noms sont renseignés, les deux doivent apparaître dans la partie. L’attribution facultative des couleurs permet de préciser qui jouait les Blancs et les Noirs." },
  "database.colorAssignment": { en: "Color assignment", de: "Farbzuordnung", fr: "Attribution des couleurs" },
  "database.searchResults": { en: "Search results", de: "Suchergebnisse", fr: "Résultats de recherche" },
  "database.searchStartHint": { en: "Combine player, year, result and rating filters as needed.", de: "Spieler-, Jahres-, Ergebnis- und Elo-Filter können beliebig kombiniert werden.", fr: "Combinez librement les filtres de joueur, d’année, de résultat et de classement." },
  "database.noSearchResults": { en: "No games match the selected filters.", de: "Keine Partien entsprechen den gewählten Filtern.", fr: "Aucune partie ne correspond aux filtres sélectionnés." },
  "database.resetFilters": { en: "Reset filters", de: "Filter zurücksetzen", fr: "Réinitialiser les filtres" },
  "database.loadGameAction": { en: "Load", de: "Laden", fr: "Charger" },
  "database.loadingGameAction": { en: "Loading…", de: "Lädt…", fr: "Chargement…" },
  ...
  "settings.scanningSystem": { en: "Scanning the configured server engine directory and validating UCI handshakes…", de: "Konfiguriertes Server-Engine-Verzeichnis wird durchsucht und UCI-Handshakes werden geprüft…", fr: "Analyse du répertoire serveur configuré et validation des handshakes UCI…" },
  "settings.discoveredServerEngines": { en: "Discovered server engines", de: "Gefundene Server-Engines", fr: "Moteurs détectés sur le serveur" },
  "settings.noDiscoveredServerEngines": { en: "No unregistered server engine found", de: "Keine unregistrierte Server-Engine gefunden", fr: "Aucun moteur serveur non enregistré trouvé" },
  "settings.chooseDiscoveredEngine": { en: "Choose discovered engine…", de: "Gefundene Engine auswählen…", fr: "Choisir un moteur détecté…" },
  "settings.serverDiscoveryFound": { en: "{count} server engine(s) available for registration.", de: "{count} Server-Engine(s) zur Registrierung verfügbar.", fr: "{count} moteur(s) serveur disponible(s) pour l’enregistrement." },
  "settings.serverDiscoveryFailed": { en: "Could not discover engines on the server.", de: "Server-Engines konnten nicht ermittelt werden.", fr: "Impossible de détecter les moteurs sur le serveur." },
