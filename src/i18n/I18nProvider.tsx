...
const translations = {
  ...
  "database.playerPairHint": { en: "Player 1 and Player 2 match either color. If both are set, both names must occur in the game.", de: "Spieler 1 und Spieler 2 gelten unabhängig von der Farbe. Sind beide gesetzt, müssen beide Namen in der Partie vorkommen.", fr: "Joueur 1 et Joueur 2 peuvent avoir n’importe quelle couleur. Si les deux sont renseignés, les deux noms doivent apparaître dans la partie." },
